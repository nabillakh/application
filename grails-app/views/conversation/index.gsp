		...
		<div id="list-conversation" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="lastDate" title="${message(code: 'conversation.lastDate.label', default: 'Last Date')}" />
				...
				<g:each in="${conversationInstanceList}" status="i" var="conversationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${conversationInstance.id}">${fieldValue(bean: conversationInstance, field: "lastDate")}</g:link></td>
