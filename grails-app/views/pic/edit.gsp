...
<html>
	...
	<body>
		...
		<div id="edit-pic" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${picInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${picInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:picInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${picInstance?.version}" />
				<fieldset class="form">
