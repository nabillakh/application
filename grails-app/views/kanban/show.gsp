                                                                                ...
                                                                                <g:each in="${ofs}" status="i" var="ofInstance">
                                                                                  <div>
                                                                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                                                                     <!-- <td><g:link action="show" controller="OF" id="${ofInstance.id}">${fieldValue(bean: ofInstance, field: "phase")}</g:link></td> -->
									        ...
									        <div class="inner-spacer chat-widget widget-content-padding"> 
									              ...
									              <div class="tab-pane fade in active" id="user1">
									              	...
									              	<div class="chat-messages">
									              		...
									              		<!-- message -->
                                                                                                ...
                                                                                                <g:each in="${cRendus}" status="i" var="crInstance">
                                                                                                  <div>
                                                                                                    <p id="message-id">
                                                                                                      <span class="message">
                                                                                                        <strong>${fieldValue(bean: crInstance, field: "author")}</strong> 
                                                                                                        <span class="message-time">${fieldValue(bean: crInstance, field: "dateCreated")}</span>
                                                                                                        <span class="message-text">${fieldValue(bean: crInstance, field: "message")}</i></span>
                                                                                                      </span>
                                                                                                    </p>
                                                                                                  </div>
                                                                                                </g:each>
									            ...
									            <!-- end chat box -->
                                                                                    ...
                                                                                    <div class="updateStatusForm">
                                                                                      <g:formRemote url="[action: 'updateCompteRendu']" update="messages" name="updateStatusForm"
                                                                                                    onSuccess="document.getElementById('message').value='';">
                                                                                        <g:textArea name="message" value=""/><br/>
                                                                                        <g:hiddenField name="kanban" value="${kanbanInstance.id}"/>
                                                                                        <g:submitButton name="Update Status" id="update_status_button"/>
                                                                                      </g:formRemote>
                                                                                    </div>
                                                                                    <div id="messages">
                                                                                      <compteRendus:renderMessages messages="${compteRenduMessages}"/>
                                                                                    </div>
