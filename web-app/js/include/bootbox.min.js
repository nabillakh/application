   ...
   Location : <input type='text' name='location' id='location'    /> \n\
    ...
    var j=function(){ "function"===typeof e&&e(null)},
        ...
        {label:c,icon:g.CONFIRM,callback:function()
            {"function"===typeof e&&e(d.find("input[name='title']").val());
                e&&e(d.find("input[name='location']").val());
                e&&e(d.find("input[name='description']").val());
                e&&e(d.find("input[name='startTime']").val());
                e&&e(d.find("input[name='endTime']").val());}}],
