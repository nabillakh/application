...
ajoutEvent:function() {
    ...
    var d=n("<form  name='eventInstance' id = 'eventInstance'>  Titre : \n\
<input type='text' name='title'  id='title'  /> </br>\n\
   Location : <input type='text' name='location' id='location'    /> \n\
</br>  Description :  <input type='text' name='description' id='description'    /> \n\
</br>  Du : <input type='date' name='startTime' id='startTime' precision='day'    />\n\
 </br>  Fin : <input type='date' name='endTime' id='endTime' precision='day'    /> \n\
</form> ");
                            
    d.append("<input autocomplete=off type=text value='"+j+"' />");
