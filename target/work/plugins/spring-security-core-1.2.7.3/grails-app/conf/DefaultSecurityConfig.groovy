...
security {
	...
	userLookup.userDomainClassName = 'application.RH.Effectif'
	...
	userLookup.authorityJoinClassName = 'application.RH.EffectifDroit'
	authority.className = 'application.RH.Droit'
