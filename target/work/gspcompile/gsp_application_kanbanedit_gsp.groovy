...
printHtmlPart(50)
invokeTag('submitButton','g',151,['class':("btn btn-primary"),'name':("create"),'value':("Mettre à jour")],-1)
printHtmlPart(51)
})
invokeTag('form','g',156,['url':([action:'nouveauKanban'])],2)
printHtmlPart(52)
invokeTag('render','g',187,['template':("/menues/mainright")],-1)
printHtmlPart(53)
expressionOut.print(request.contextPath)
printHtmlPart(54)
expressionOut.print(request.contextPath)
