...
class gsp_application_mailEffectifshow2_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mailEffectif/show2.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(22)
invokeTag('fieldValue','g',55,['bean':(mailEffectifInstance.mail),'field':("message")],-1)
printHtmlPart(15)
}
printHtmlPart(23)
createTagBody(2, {->
...
public static final long LAST_MODIFIED = 1398757020487L
