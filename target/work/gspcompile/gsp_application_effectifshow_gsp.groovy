...
invokeTag('link','g',26,['action':("show"),'controller':("Equipe"),'id':(" ${effectifInstance.equipe.id}")],2)
printHtmlPart(14)
expressionOut.print(effectifInstance.id)
printHtmlPart(15)
expressionOut.print(request.contextPath)
printHtmlPart(16)
expressionOut.print(effectifInstance.id)
...
printHtmlPart(24)
invokeTag('remoteFunction','g',97,['controller':("kanban"),'action':("obtenirKanbanEffectif"),'params':("\'effectif=\' + monId"),'update':("contenu2")],-1)
printHtmlPart(25)
...
public static final long LAST_MODIFIED = 1401189043309L
