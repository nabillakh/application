...
class gsp_application_adminindex_gsp extends GroovyPage {
...
invokeTag('form','g',18,['action':("upload"),'method':("post"),'enctype':("multipart/form-data")],2)
printHtmlPart(6)
})
...
public static final long LAST_MODIFIED = 1401174043330L
