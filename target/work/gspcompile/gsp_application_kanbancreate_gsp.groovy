...
invokeTag('link','g',150,['action':("index"),'controller':("kanban"),'class':(" btn btn-warning")],3)
printHtmlPart(48)
invokeTag('submitButton','g',151,['class':("btn btn-primary"),'name':("create"),'value':("Créer")],-1)
printHtmlPart(49)
})
invokeTag('form','g',155,['url':([action:'nouveauKanban'])],2)
printHtmlPart(50)
invokeTag('render','g',186,['template':("/menues/mainright")],-1)
printHtmlPart(51)
expressionOut.print(request.contextPath)
printHtmlPart(52)
expressionOut.print(request.contextPath)
