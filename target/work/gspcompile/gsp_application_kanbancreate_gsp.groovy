...
printHtmlPart(46)
invokeTag('submitButton','g',148,['class':("btn btn-primary medium"),'name':("create"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(47)
})
invokeTag('form','g',150,['url':([action:'nouveauKanban'])],2)
printHtmlPart(48)
invokeTag('render','g',181,['template':("/menues/mainright")],-1)
printHtmlPart(49)
expressionOut.print(request.contextPath)
printHtmlPart(50)
expressionOut.print(request.contextPath)
...
public static final long LAST_MODIFIED = 1399053173459L
