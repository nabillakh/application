...
invokeTag('link','g',160,['action':("show"),'controller':("Kanban"),'id':(kanbanInstance.id)],3)
printHtmlPart(48)
expressionOut.print(fieldValue(bean: kanbanInstance, field: "description"))
printHtmlPart(48)
expressionOut.print(kanbanInstance.phaseActuelle?.nom)
printHtmlPart(48)
invokeTag('formatDate','g',163,['date':(kanbanInstance.dateFinPlanifie)],-1)
printHtmlPart(48)
...
invokeTag('link','g',186,['action':("create"),'controller':("Kanban"),'class':("btn btn-primary medium pull-right")],2)
printHtmlPart(52)
invokeTag('remoteFunction','g',210,['controller':("kanban"),'action':("delete"),'params':("\'kanban=\' + monId")],-1)
printHtmlPart(53)
invokeTag('render','g',221,['template':("/menues/mainright")],-1)
printHtmlPart(54)
expressionOut.print(request.contextPath)
printHtmlPart(55)
expressionOut.print(request.contextPath)
...
public static final long LAST_MODIFIED = 1401189043375L
