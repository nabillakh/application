...
class gsp_application_kanbanindex_gsp extends GroovyPage {
...
invokeTag('link','g',88,['action':("show"),'controller':("Kanban"),'id':(kanbanInstance.id)],2)
printHtmlPart(8)
...
printHtmlPart(8)
invokeTag('formatDate','g',91,['date':(kanbanInstance.dateFinPlanifie)],-1)
printHtmlPart(8)
...
invokeTag('link','g',109,['action':("create"),'controller':("Kanban"),'class':("btn medium")],1)
printHtmlPart(12)
...
public static final long LAST_MODIFIED = 1399041410881L
