...
class gsp_application_kanbanobtenirKanbanEffectif_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/kanban/obtenirKanbanEffectif.gsp" }
public Object run() {
Writer out = getOut()
