...
ajoutEvent:function() {
    ...
    {case 1:b=arguments[0];
        ...
        case 3:b=arguments[0];
            ...
            break;
        case 4:b=arguments[0];a=arguments[1];
            c=arguments[2];e=arguments[3];
            break;
        case 5:b=arguments[0];a=arguments[1];c=arguments[2];e=arguments[3];j=arguments[4];
            break;
        default:throw Error("Incorrect number of arguments: expected 1-5");
    }
    
    var d=n("<table><form  name='eventInstance' id = 'eventInstance'>  <tr><td>Titre </td><td>:<td></td></td> \n\
<td><input type='text' name='title'  id='title'  /></td></tr> \n\
<tr><td> Lieu </td><td>:</td> <td></td><td><input type='text' name='location' id='location' /> \n\
<tr><td> Description </td><td>:</td><td></td><td><input type='text' name='description' id='description'    /></td></tr> \n\
<tr><td> Du </td><td>:</td><td></td><td> <input type='date' name='startTime' id='startTime' precision='day'    /></td></tr>\n\
<tr><td> Fin </td><td>:</td><td></td><td><input type='date' name='endTime' id='endTime' precision='day'    /> </td></tr>\n\
</form> <table>");
                            
   
                            
    var j=function(){ "function"===typeof e&&e(null)},
            k=m.dialog( d,[
        {label:a,icon:g.CANCEL,callback:j},
        {label:c,icon:g.CONFIRM,callback:function()
            {   if (typeof e === 'function') {
                    
                   // creation du json de l'evenement
                    var json = {title : d.find("input[name='title']").val()
                        , lieu:  d.find("input[name='location']").val()
                        , description: d.find("input[name='description']").val()
                        , start:  d.find("input[name='startTime']").val()
                        , end:  d.find("input[name='endTime']").val()                        
                    };
                    // insertion du json dans l'output e
                    e(json)}
        }}],
    {header:b,show:!1,onEscape:j});
    k.on("shown",function(){
        d.find("input[name='title']").focus();
    ...
    k.modal("show");return k},


clickSurEvent:function() {
            var b="",
            a=h("CANCEL"),
            c=h("CONFIRM"),
            e=null,
    ...
    // ici il faut faire venir la date de debut et de fin dans le bon format. 
    var d=n("<table><form  name='eventInstance' id = 'eventInstance'>  <tr><td>Titre </td><td>:<td></td></td> \n\
<td><input class='span3' type='text' name='title'  id='title' value="+$('#title').val()+"  /></td></tr> \n\
<tr><td> Lieu </td><td>:</td> <td></td><td><input type='text' name='location' id='location' value="+$('#lieu').val()+"  /> \n\
<tr><td> Description </td><td>:</td><td></td><td><input type='text' name='description' id='description'  value="+$('#description').val()+"    /></td></tr> \n\
<tr><td> Du </td><td>:</td><td></td><td> <input type='date' name='startTime' id='startTime' precision='day'   value="+$('#dateDeb').val()+"   /></td></tr>\n\
<tr><td> Fin </td><td>:</td><td></td><td><input type='date' name='endTime' id='endTime' precision='day'    /> </td></tr>\n\
</form> <table>");
...
dialog:function(b,a,c){var e="",j=[];c=c||{};null==a?a=[]:"undefined"==typeof a.length&&(a=
